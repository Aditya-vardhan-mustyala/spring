...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="${pageContext.request.contextPath}/home " class="w3-bar-item w3-button w3-wide">HOME</a>
	...
	<table class="table table-bordered table-striped">
		...
		<c:forEach var="game" items="${games}">
			<tr>
                ...
                <td> ${game.price} </td>
                <c:url var="cartLink" value="/deletefromcart">
                     <c:param name="gameId" value="${game.id}" />
                </c:url>
                <td><a href="${cartLink}"><lable class='btn btn-dark btn-sm mb-3 w3-black w3-button'>Remove from cart</lable></a></td>
        	</tr>
        </c:forEach>
